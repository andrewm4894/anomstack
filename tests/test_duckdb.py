...
class TestReadSqlDuckdb:
    ...
    @patch('anomstack.external.duckdb.duckdb.query')
    @patch('os.makedirs')
    def test_read_sql_duckdb_motherduck_error_fallback(self, mock_makedirs, mock_query, mock_connect, mock_logger):
    ...
    @patch('anomstack.external.duckdb.duckdb.query')
    @patch('os.makedirs')
    def test_read_sql_duckdb_non_motherduck_error(self, mock_makedirs, mock_query, mock_connect, mock_logger):
...
class TestSaveDfDuckdb:
    ...
    @patch('anomstack.external.duckdb.duckdb.query')
    @patch('os.makedirs')
    def test_save_df_duckdb_insert_existing_table(self, mock_makedirs, mock_query, mock_connect, mock_logger):
...
class TestRunSqlDuckdb:
    ...
    @patch('anomstack.external.duckdb.duckdb.query')
    @patch('os.makedirs')
    def test_run_sql_duckdb_error_handling(self, mock_makedirs, mock_query, mock_connect, mock_logger):
