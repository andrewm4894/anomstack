...
class TestSaveDfDuckdb:
    ...
    def test_save_df_duckdb_create_table(
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            mock_query.assert_any_call(
                ...
                query="INSERT INTO test_table (col1, col2) SELECT col1, col2 FROM df",
            )
            mock_query.assert_any_call(
    ...
    def test_save_df_duckdb_insert_existing_table(
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            mock_query.assert_called_once_with(
                connection=mock_conn,
                query="INSERT INTO existing_table (col1, col2) SELECT col1, col2 FROM df",
            )
            pd.testing.assert_frame_equal(result, df)
    ...
    def test_save_df_duckdb_with_schema(self, mock_makedirs, mock_query, mock_connect, mock_logger):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            mock_query.assert_any_call(
                connection=mock_conn,
                query="INSERT INTO my_schema.test_table (col1, col2) SELECT col1, col2 FROM df",
            )
            mock_query.assert_any_call(
