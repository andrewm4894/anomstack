...
email_from = os.getenv("ANOMSTACK_FAILURE_EMAIL_FROM", os.getenv("ANOMSTACK_ALERT_EMAIL_FROM"))
email_password = os.getenv(
    "ANOMSTACK_FAILURE_EMAIL_PASSWORD", os.getenv("ANOMSTACK_ALERT_EMAIL_PASSWORD")
)
email_to = os.getenv("ANOMSTACK_FAILURE_EMAIL_TO", os.getenv("ANOMSTACK_ALERT_EMAIL_TO", "")).split(
    ","
)
